...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid p-0">
        <div class="position-relative text-white text-center d-flex align-items-center justify-content-center vh-100">
            ...
            <div class="container position-relative">
                <h1 class="display-3 fw-bold text-uppercase mb-3">Vocational Programs</h1>
    ...
    <asp:Repeater ID="rpVocDepartments" runat="server" OnItemDataBound="rpVocDepartments_ItemDataBound">
        <ItemTemplate>
            <section class='<%# Container.ItemIndex % 2 == 0 ? "py-5 bg-white" : "py-5 bg-light" %>'>
                <div class="container py-5">
                    ...
                    <div class="d-flex flex-column gap-5">
                        <asp:Repeater ID="rpVocPrograms" runat="server">
                            <ItemTemplate>
