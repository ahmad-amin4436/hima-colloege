    ...
    <div class="position-relative text-white text-center d-flex align-items-center justify-content-center vh-100">
        <div class="position-absolute w-100 h-100">
            <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1600&q=80"
                 class="w-100 h-100 object-fit-cover" alt="HIMA Student Hub" />
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <div class="ratio ratio-16x9 shadow-sm">
                    <img src="https://images.unsplash.com/photo-1541339907198-e08756ebafe1?auto=format&fit=crop&w=800&q=80" 
                         class="object-fit-cover border border-light" alt="Campus Life" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="ps-lg-4">
                    ...
                    <div class="p-4 bg-light border-start border-success border-4 rounded-0">
    ...
    <div class="container py-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            <div class="col">
                <div class="card h-100 border-0 shadow-sm rounded-0">
                    <div class="ratio ratio-4x3">
                        <img src="https://images.unsplash.com/photo-1521503862198-2ae9a997bbc9?auto=format&fit=crop&w=600&q=80" class="object-fit-cover" alt="Beautician Lab" />
                    </div>
                    <div class="card-body p-4 border-top border-success border-4 d-flex flex-column">
            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-sm rounded-0">
                    <div class="ratio ratio-4x3">
                        <img src="https://images.unsplash.com/photo-1528469133842-87ba42a42531?auto=format&fit=crop&w=600&q=80" class="object-fit-cover" alt="Sewing Lab" />
                    </div>
                    <div class="card-body p-4 border-top border-success border-4 d-flex flex-column">
            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-sm rounded-0">
                    <div class="ratio ratio-4x3">
                        <img src="https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&w=600&q=80" class="object-fit-cover" alt="Cricket Ground" />
                    </div>
                    <div class="card-body p-4 border-top border-success border-4 d-flex flex-column">
            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-sm rounded-0">
                    <div class="ratio ratio-4x3">
                        <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=600&q=80" class="object-fit-cover" alt="Vocational Hub" />
                    </div>
                    <div class="card-body p-4 border-top border-success border-4 d-flex flex-column">
...
<section id="activities" class="py-5 bg-white">
    <div class="container py-5">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="row g-0 border shadow-sm h-100">
                    <div class="col-sm-4">
                        <div class="h-100 ratio ratio-1x1">
                            <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=400&q=80" class="object-fit-cover" alt="Independence Day" />
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="row g-0 border shadow-sm h-100">
                    <div class="col-sm-4">
                        <div class="h-100 ratio ratio-1x1">
                            <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=400&q=80" class="object-fit-cover" alt="Industrial Tours" />
                        </div>
                    </div>
                    <div class="col-sm-8 p-4 d-flex flex-column justify-content-center">
            ...
            <div class="col-md-6">
                <div class="row g-0 border shadow-sm h-100">
                    <div class="col-sm-4">
                        <div class="h-100 ratio ratio-1x1">
                            <img src="https://images.unsplash.com/photo-1475721027785-f74dea9f2682?auto=format&fit=crop&w=400&q=80" class="object-fit-cover" alt="Guest Lectures" />
                        </div>
                    </div>
                    <div class="col-sm-8 p-4 d-flex flex-column justify-content-center">
            ...
            <div class="col-md-6">
                <div class="row g-0 border shadow-sm h-100">
                    <div class="col-sm-4">
                        <div class="h-100 ratio ratio-1x1">
                            <img src="https://images.unsplash.com/photo-1599059813005-11265ba4b4ce?auto=format&fit=crop&w=400&q=80" class="object-fit-cover" alt="Safety Training" />
                        </div>
                    </div>
                    <div class="col-sm-8 p-4 d-flex flex-column justify-content-center">
