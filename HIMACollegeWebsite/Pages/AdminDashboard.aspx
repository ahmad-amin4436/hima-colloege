...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-end mb-4 border-bottom border-success pb-3">
        <div>
            ...
            <p class="text-muted small mb-0 text-uppercase">Administrative Suite v3.0</p>
        </div>
        <div class="text-end">
    ...
    <div class="row g-0 mb-5 shadow-sm border border-2">
        <div class="col-md-4"><asp:LinkButton ID="btnTabProg" runat="server" OnClick="SwitchView" CommandArgument="0" CssClass="btn btn-success w-100 rounded-0 py-4 fw-bold border-end">PROGRAMS</asp:LinkButton></div>
        <div class="col-md-4"><asp:LinkButton ID="btnTabAdm" runat="server" OnClick="SwitchView" CommandArgument="1" CssClass="btn btn-dark w-100 rounded-0 py-4 fw-bold border-end">ADMISSIONS</asp:LinkButton></div>
        <div class="col-md-4"><asp:LinkButton ID="btnTabFac" runat="server" OnClick="SwitchView" CommandArgument="2" CssClass="btn btn-dark w-100 rounded-0 py-4 fw-bold">FACULTY</asp:LinkButton></div>
    </div>
    ...
    <asp:MultiView ID="MainMultiView" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="ViewPrograms" runat="server">
            <div class="card border-0 rounded-0 shadow-sm border-start border-success border-5 mb-4">
                <div class="card-header bg-dark text-white rounded-0"><h5 class="mb-0 small fw-bold">MANAGE PROGRAMS</h5></div>
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="txtStartDate" runat="server" CssClass="form-control rounded-0 border-2" placeholder="e.g. Sept 2026"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
        ...
        <asp:View ID="ViewAdmissions" runat="server">
             <div class="card border-0 rounded-0 shadow-sm border-start border-success border-5">
                <div class="card-header bg-dark text-white rounded-0"><h5 class="mb-0 small fw-bold">UPLOAD DOCUMENTS</h5></div>
